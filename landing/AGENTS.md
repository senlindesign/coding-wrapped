...
- Keep a four-item pixel Dock fixed near the bottom edge: Coding Wrapped, GitHub, Sen, and Buy Me a Coffee. Use brand-led tile colors: Coding Wrapped cream, GitHub black with a white Octocat, Sen orange, and Buy Me a Coffee yellow. Preserve one coherent pixel density, rounded tile outline, hard shadow, hover lift, readable labels, and a lightly translucent blurred-glass tray.
...
- Continue from the demo into How it works and Install without a separate white section mask.
